...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Roll Anime to Fight Wiki',
    description: 'Copyright and intellectual property information for Roll Anime to Fight Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Roll Anime to Fight Wiki',
      description: 'Copyright and intellectual property information for Roll Anime to Fight Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Roll Anime to Fight Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Roll Anime to Fight Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Roll Anime to Fight Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Another Slop</strong> - Creators of the Roll Anime to Fight game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Roll Anime to Fight</strong> - Trademark of the game developers</li>
              <li><strong>Roll Anime to Fight Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Roll Anime to Fight Wiki.
            </p>
            ...
            <p>
              ...
              Roll Anime to Fight Wiki<br />
              Email: <a href="mailto:dmca@rollanimetofight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rollanimetofight.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Roll Anime to Fight Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Roll Anime to Fight Wiki (rollanimetofight.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@rollanimetofight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@rollanimetofight.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@rollanimetofight.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@rollanimetofight.wiki</a>
            </p>
            <p>
